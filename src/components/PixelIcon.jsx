 ...
 */
export const PixelIcon = ({ name, className = "w-6 h-6", color = "currentColor", style = {} }) => {
  const defaultStyle = { shapeRendering: 'crispEdges', flexShrink: 0, ...style };

  const icons = {
    // Cute Pixel Bread (from screenshot)
    bread: (
      <svg viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} style={defaultStyle}>
    ...
    // Pixel 3-Bar / Menu Hamburger
    menu: (
      <svg viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} style={defaultStyle}>
        <path d="M2 3h12v2H2V3zM2 7h12v2H2V7zM2 11h12v2H2v-2z" fill={color} />
      </svg>
    ),
    ...
    close: (
      <svg viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} style={defaultStyle}>
        <path d="M3 3h2v2H3V3zM5 5h2v2H5V5zM7 7h2v2H7V7zM9 5h2v2H9V5zM11 3h2v2h-2V3zM9 9h2v2H9V9zM11 11h2v2h-2v-2zM5 9h2v2H5V9zM3 11h2v2H3v-2z" fill={color} />
      </svg>
    ),
  };
